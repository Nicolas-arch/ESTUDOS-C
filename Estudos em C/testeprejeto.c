...
int main()
{
    ...
    int i,j,k,l;
    float soma_despesa_1,soma_despesa_2;
    float despesa_1[max][max],receita_1[max][max],lucro_1[max][max];
    float despesa_2[max][max],receita_2[max][max],lucro_2[max][max];
    float soma_1,menor=9999,soma_coluna_1[max];
    float soma_2,maior=-9999,soma_linha_2[max];
    float vet_dep_lucro1[max],med_dep1[max],soma_lucro_1;
    float vet_dep_lucro2[max],med_dep2[max],soma_lucro_2;
